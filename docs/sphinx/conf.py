...
from roboscheduler import __version__
...
htmlhelp_basename = '{0}pdoc'.format('roboscheduler')
...
man_pages = [
    (master_doc, 'roboscheduler', u'{0} Documentation'.format(project),
     [author], 1)
]
