...
class Cadence(cCadenceCore.CadenceCore):
    ...
    def __init__(self, name=None, nepochs=None, skybrightness=None,
        ...
        self.brightDurDarkPenalty = priorities.get("brightDurDarkPenalty", -500)
    ...
    def evaluate_next(self, epoch_idx=None, partial_epoch=False,
        ...
        if verbose:
            ...
            print(f"use {self.min_deltav_ks91[epoch_idx]:.1f} {self.max_airmass[epoch_idx]:.1f} {self.min_moon_sep[epoch_idx]:.1f} {mjd_next}")
            print(f"{total} {deltaV:.1f} {airmass:.1f} {moon_dist:.1f} {mjd_next}")
