...
class Scheduler(Master):
    ...
    def initdb(self, designbase='plan-0'):
        ...
        self.cadences = roboscheduler.cadence.CadenceFile(filebase=filebase)
        self.fields = roboscheduler.fields.FieldsFile(filebase=filebase)
