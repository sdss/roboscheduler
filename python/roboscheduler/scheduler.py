...
class Scheduler(object):
    ...
    def __init__(self, airmass_limit=2.):
        ...
        """
        self.master = roboscheduler.master.Master()
        self.observer = roboscheduler.master.Observer()
    ...
    def initdb(self):
        ...
        """
        self.fields = roboscheduler.fields.Fields(observatory=self.observer.observatory)
        self.observations = roboscheduler.observations.Observations(observatory=self.observer.observatory)
        return
